...
public class AdapterUserFeed extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterUserFeed(FragmentActivity context, List<DataRecycler> data) {
        ...
        if (holder instanceof MyHolder) {
            ...
            if(current.getFirst_load().equals("1")) {
                ...
                myHolder.caption.post(new Runnable() {
                    ...
                    @Override
                    public void run() {
                        if(myHolder.caption.getLineCount()>=7){
                ...
                if (current.is_image.equals("1")) {
                    ...
                    myHolder.caption.setTextSize((float)20);
                }

                //Getting the post image
                String URL = "http://13.233.234.79/uploads/post_images/"
                        + current.getUser_id()
