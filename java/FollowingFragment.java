...
public class FollowingFragment extends Fragment {
    ...
    private ImageView no_following,no_internet;
    ...
    private static final String URL = "http://13.233.234.79/following_number_un.php";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        toolbar_title.setText(getResources().getString(R.string.following_number));
        ...
        no_following = v.findViewById(R.id.no_following);
    ...
    private void following_users(final int last){
        ...
        mStringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    no_following.setVisibility(View.GONE);
                    ...
                    if(data.size()==0){
                        no_internet.setVisibility(View.GONE);
                        no_following.setVisibility(View.VISIBLE);
                    }
